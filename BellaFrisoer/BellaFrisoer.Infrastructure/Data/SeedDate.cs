...
namespace BellaFrisoer.Infrastructure.Data
{
    internal class SeedDate
    {
        ...
        {
            using var context = serviceProvider.GetRequiredService<BellaFrisoerWebUIContext>();

            if (context == null || context.ICustomer == null)
            {
                throw new NullReferenceException("Null BellaFrisoerWebUIContext or Movie DbSet");
            }
    ...
    internal class BellaFrisoerWebUIContext : DbContext
    {
